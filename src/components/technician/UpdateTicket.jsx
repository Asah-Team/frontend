...
export default function UpdateTicketModal({ isOpen, ticket, onClose, onConfirm }) {
  ...
  const getAvailableStatuses = (currentStatus) => {
    const map = { open: ['in_progress'], in_progress: ['closed', 'open'], closed: [], canceled: [] };
        ...
        <div className="p-8">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-gray-600 break-words whitespace-pre-wrap pt-1 max-h-40 overflow-y-auto pr-2">
                    {ticket.description}
                  </p>
                </div>
              </div>
          ...
          <div className="mb-8">
            ...
            <select 
              ...
              className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-amber-500 focus:outline-none bg-white transition"
            >
          ...
          <div className="flex gap-4">
            <button onClick={() => onConfirm(newStatus)} className="flex-1 bg-amber-500 hover:bg-amber-600 text-white py-3.5 rounded-xl font-bold transition shadow-lg shadow-amber-200 flex items-center justify-center">
