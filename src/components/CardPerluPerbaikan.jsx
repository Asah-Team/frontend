...
/**
 * Backend mengirim:
 * - jumlah: total mesin rusak
 * - progress: 0–100
 * - color: warna HEX/RGB dari backend
 */
export default function CardPerluPerbaikan({ jumlah, progress, color }) {
  const chartData = [{ name: "Repair", value: progress || 0 }];

  return (
    <div className="bg-white p-6 rounded-[20px] shadow border flex flex-col justify-between">
      <div className="flex items-center gap-2">
        <Wrench size={22} style={{ color: color || "#ef4444" }} />
